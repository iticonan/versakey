...
module.exports = {
    ...
    body: p => {
        ...
        const segments = `
	(segment (start ${adjust_point(-1.65, 0)}) (end ${adjust_point(-3.81, 0)}) (width 0.25) (layer "F.Cu") (net 0))
	(segment (start ${adjust_point(-1.65, 0)}) (end ${adjust_point(-3.81, 0)}) (width 0.25) (layer "B.Cu") (net 0))
	(segment (start ${adjust_point(1.65, 0)}) (end ${adjust_point(3.81, 0)}) (width 0.25) (layer "F.Cu") (net 1))
	(segment 
	    (start ${adjust_point(3.81, 0)})
	    (end ${adjust_point(1.65, 0)})
            (width 0.25)
            (layer "B.Cu")
            (net 1)
	)
    ...
    (footprint "ceoloide:diode_tht_sod123"
        ...
        `
        const front = `
        (fp_line (start 0.25 1) (end 0.75 1) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start 0.25 1.4) (end -0.35 1) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start 0.25 0.6) (end 0.25 1.4) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end 0.25 0.6) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end -0.35 1.55) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end -0.35 0.45) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.75 1) (end -0.35 1) (layer "F.SilkS") (stroke (width 0.1) (type solid)))
        ...
        `
        const back = `
        (fp_line (start 0.25 1) (end 0.75 1) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start 0.25 1.4) (end -0.35 1) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start 0.25 0.6) (end 0.25 1.4) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end 0.25 0.6) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end -0.35 1.55) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.35 1) (end -0.35 0.45) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
        (fp_line (start -0.75 1) (end -0.35 1) (layer "B.SilkS") (stroke (width 0.1) (type solid)))
